...
<head>
  <meta charset="UTF-8">
  <title>CRUD Cabin ({{ $mode }}) - Bobocabin Admin</title>
...
<body class="bg-gray-50 p-6">
  ...
  <nav class="bg-white shadow-md mb-8 p-4 sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <ul class="flex space-x-6">
        <li><a href="/admin/dbhelper" class="text-gray-700 hover:text-green-700 font-medium {{ $mode == 'DB Helper' ? 'font-bold underline text-emerald-800' : '' }}">DB Helper</a></li>
        <li><a href="/admin/qb" class="text-gray-700 hover:text-green-700 font-medium {{ $mode == 'Query Builder' ? 'font-bold underline text-emerald-800' : '' }}">Query Builder</a></li>
        <li><a href="/admin/orm" class="text-gray-700 hover:text-green-700 font-medium {{ $mode == 'ORM (Eloquent)' ? 'font-bold underline text-emerald-800' : '' }}">ORM (Eloquent)</a></li>
  ...
  <script>
    ...
    function editCabin(id, nama, lokasi, harga, gambar) {
      ...
      submitButton.classList.replace('bg-green-700', 'bg-blue-700');
    ...
    cancelButton.addEventListener('click', () => {
      ...
      submitButton.classList.replace('bg-blue-700', 'bg-green-700');
