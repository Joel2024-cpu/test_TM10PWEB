  ...
  <nav class="bg-white shadow p-4 sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <ul class="flex space-x-6">
        ...
        @if(session('role'))
          <li><a href="/logout" class="text-gray-700 hover:text-red-600 font-medium">Logout</a></li>
        @else
          <li><a href="/login" class="text-gray-700 hover:text-bobogreen font-medium">Admin</a></li>
        @endif
      </ul>
    </div>
  </nav>
